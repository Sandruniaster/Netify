...
import pl.edu.ug.aib.netify.fragment.SearchFriendsFragment;
...
public class HomeActivity extends ActionBarActivity implements UserGroupsFragment.OnUserGroupsFragmentCommunicationListener,
        ...
        SearchFriendsFragment.OnSearchFriendsFragmentCommunicationListener
...

{
    ...
    public void getUserFriendsList() {
        restBackgroundTask.getUserFriends(Integer.toString(preferences.id().get()));
    }
    public void onUserFriendsListDownloaded(FriendsDataList friendsDataList){
        try {
            FriendsFragment fragment = (FriendsFragment)drawerHandler.getCurrentFragment();
            fragment.setUserFriends(friendsDataList);
        }
        catch (ClassCastException e){
            Log.d(this.getClass().getSimpleName(), "Fragment must be instance of UserGroupsFragment");
        }
    ...
    public void searchForFriends(String query) {
        restBackgroundTask.searchFriends(query);
    }
    public void onSearchFriendCompleted(FriendsDataList friendsDataList){
        try {
            SearchFriendsFragment fragment = (SearchFriendsFragment)drawerHandler.getCurrentFragment();
            fragment.setSearchedFriends(friendsDataList);
        }
        catch (ClassCastException e){
            Log.d(this.getClass().getSimpleName(), "Fragment must be instance of UserFriendsFragment");
        }
    }
